        ...
        <div class="card-body">
            ...
            <div class="table-responsive tbl-padding">
                <form id="statuslist" method="post" >
                    ...
                    <input type="hidden" name="listtbl" value="pdf">
                    <input type="hidden" name="page_name" value="Pdf">
                    <input type="hidden" id="url22" value="fetch-pdflist">
...
<div class="modal fade" id="seqeditauthor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <form class="update-seqpdf" method="post">                   
