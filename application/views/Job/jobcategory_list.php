        ...
        <div class="card-body">
            ...
            <div class="table-responsive tbl-padding">
                <form id="statuscategory" method="post" >
                    <input type="hidden" name="category_tbl" value="job_category">
                    <input type="hidden" name="listtbl" value="job">
                    <input type="hidden" name="page_name" value="Job Category">
                    <input type="hidden" id="url22" value="fetch-jobcategorylist">
...
<div class="modal fade" id="seqeditauthor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <form class="update-seqjobcat" method="post">                   
