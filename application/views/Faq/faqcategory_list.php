    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="card-header p-0">FAQ's Category List</h5>
                <?php
                ...
                if ($rrr->num_rows() > 0) {
                    ...
                    if ($res->num_rows() > 0) {
                        ?>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalAdd">Add FAQ's Category</button>
                        <?php
                    } else {
            ...
            <div class="table-responsive tbl-padding">
                <form id="statuscategory" method="post" >
                    <input type="hidden" name="category_tbl" value="faq_category">
                    <input type="hidden" name="listtbl" value="faq_list">
                    <input type="hidden" name="page_name" value="Faq Category">
                    <input type="hidden" id="url22" value="fetch-faqcategorylist">
...
<div class="modal fade" id="seqeditauthor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <form class="update-seqfaqcat" method="post">                   
